...
namespace Workshop_RSWEB.Controllers
{
    public class PredmetsController : Controller
    {
        ...
        public PredmetsController(Workshop_RSWEBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Semestar,Smer")] Predmet predmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Semestar,Smer")] Predmet predmet)
        {
            if (id != predmet.Id)
            {
                return NotFound();
